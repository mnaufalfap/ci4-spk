        ...
        <div class="card-body">
          <form action="/subkriteria/create" method="post" id="formTambah">
            ...
            <div class="form-group">
              ...
              <input type="text" name="jumlahsk" id="jumlahSk" class="form-control jumlahSk" placeholder="Jumlah sub kriteria..">
            </div>
    ...
    if (jumlahSub > 0) {
      ...
      for (let i = 0; i < jumlahSub; i++) {
        ...
        <div class="form-group row">
          ...
          <div class="col-4">
            <input type="number" class="form-control" name="nilai_preferensi[]" id="np${i}" placeholder="Nilai.." min="50" max="100">
          </div>
        </div>
        `
      }
