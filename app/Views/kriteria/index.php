                ...
                <tbody>
                  <?php foreach ($kriteria as $key => $row) : ?>
                    <tr>
                      ...
                      <td><?= $key + 1; ?></td>
                      <td><?= ucfirst(str_replace("_", " ", $row['kode_kriteria'])); ?></td>
            ...
            <form action="/kriteria/create" method="POST" class="formSubmit" id="formTambah">
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="kode_kriteria" id="kode_kriteria" class="form-control" placeholder="misal..C1">
          ...
          <div class="modal-content">
            ...
            <form action="/kriteria/update" method="POST" class="formSubmit" id="formUbah">
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="nama">Kode</label>
                  <input type="text" name="kode_kriteria" id="kode_kriteria_ubah" class="form-control" placeholder="misal..C1">
                  <div class="invalid-feedback"></div>
                </div>
                <div class="form-group">
